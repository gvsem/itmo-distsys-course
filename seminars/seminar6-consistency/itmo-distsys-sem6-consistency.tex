...
% \begin{frame}{Решение задачи 3d: Иерархическая блокировка}

% \textbf{Идея:} объединить транзакции в одну, заблокировав все объекты в фиксированном порядке.

% \vspace{0.5em}

% \textbf{Объединённая транзакция:}
